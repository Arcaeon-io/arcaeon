...
from arcaeon.record.adapter.proxy import REDACTED, _redact_argv
...
MUST_NOT_TOUCH = [
    # 2026-09-01 audit (adapter #4): digit/underscore mode words were redacted.
    ["srv", "--auth", "oauth2"],
    ["srv", "--auth=saml2"],
    ["srv", "--auth", "client_credentials"],
    ...
    [sys.executable, "-m", "arcaeon.record.ledger.mcp_server", "--log", "a.jsonl"],
