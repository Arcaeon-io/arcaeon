...
without the agent's cooperation, knowledge, or consent.
    ...
    python -m arcaeon.record.adapter.proxy --ledger seam.log.jsonl -- <mcp server command...>
    python -m arcaeon.record.adapter.selftest        # every claimed check, observed failing
